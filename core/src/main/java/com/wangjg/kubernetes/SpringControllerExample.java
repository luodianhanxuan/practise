...
/**
 * Building a kubernetes controller based on spring framework's bean injection, see additional documentation:
 *
 * https://github.com/kubernetes-client/java/tree/master/docs/java-controller-tutorial-rewrite-rs-controller.md
 */
